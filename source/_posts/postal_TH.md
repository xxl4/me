---
title: THTHAILAND Postal codes 
date: 2024-12-04 13:19:00
categories: [countries]
tags: [countries, zip, zipex, postal, TH,THAILAND]
lang: en
sitemap: true
comments: true
description: Postal codes for TH Postal codes for TH are numeric, consisting of five digits. The country code of TH is THAILAND. The inital digit of the postal code is used to identify the region. The following list of postal codes for TH is not exhaustive. Please help us to improve our data by adding more postal codes in your area. You can also check the list of postal codes for other countries at https://postal-codes.cybo.com/TH/
---

# Postal codes for TH
> Postal codes for TH Postal codes for TH are numeric, consisting of five digits. The country code of TH is THAILAND. The inital digit of the postal code is used to identify the region. The following list of postal codes for TH is not exhaustive. Please help us to improve our data by adding more postal codes in your area. You can also check the list of postal codes for other countries at https://postal-codes.cybo.com/TH/

## Postal codes for TH Search 
> You can search for postal codes for TH using the search box below. Just enter the name of the place you want to search and click the search button. You can also search for postal codes for other countries at https://postal-codes.cybo.com/TH/

## Postal Codes Search Url

[https://postal-codes.cybo.com/TH/](https://postal-codes.cybo.com/TH/)
```json
{
    "id": "data\/TH",
    "key": "TH",
